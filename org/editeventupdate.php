...
$valid_extension=0;
	...
	if($yearrestrictions=="no")
		{
       mysql_query("UPDATE events SET eventname='$eventname',branch='$branch',participants='$participants',minparticipants='$minparticipants',isyearrestrictions='$yearrestrictions',description='$description',instructions='$instructions',organizers='$organizers',schedule='$schedule',prizes='$prizes' WHERE eid='$eid' AND branch='$orgbranch' ");
		}
		else
		{
  mysql_query("UPDATE events SET eventname='$eventname',branch='$branch',participants='$participants',minparticipants='$minparticipants',isyearrestrictions='$yearrestrictions',description='$description',instructions='$instructions',organizers='$organizers',schedule='$schedule',prizes='$prizes' WHERE eid='$eid' AND branch='$orgbranch' ");

  mysql_query("UPDATE isyearrestrictions SET eventname='$eventname',branch='$branch',P1='$resarP1',P2='$resarP2',E1='$resarE1',E2='$resarE2',E3='$resarE3',E4='$resarE4' WHERE eid='$eid' AND branch='$orgbranch' " );
		}
