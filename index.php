...
<meta property="og:title" content="Teckzite2k18 | RGUKTN" />
...
<meta property="og:site_name" content="Teckzite2k18  | RGUKTN" />
<meta property="og:image" content="" />

<!-- / Yoast SEO plugin. -->

<link rel='dns-prefetch' href='load-yoast.html' />
		<script type="text/javascript">
			window._wpemojiSettings = {"baseUrl":"https:\/\/s.w.org\/images\/core\/emoji\/2.2.1\/72x72\/","ext":".png","svgUrl":"https:\/\/s.w.org\/images\/core\/emoji\/2.2.1\/svg\/","svgExt":".svg","source":{"concatemoji":"http:\/\/10.11.3.55/tz\/assets\/js\/wp-emoji-release.min.js"}};
	...
	<header id="header">
		<div id="header-inner" class="clearfix">
			...
			<div id="lang-navi" class="white pc">
				...
				<p class="en active"><a href="en/index.html">EN</a></p>
			</div>
			<div id="gnavi-trigger">
				
					<div class="line" style="color:#fff;"><img src="assets/img/toggle.png" style="width:200%;">Menu</div>
		...
		<div id="gnavi-inner">
			...
			<div id="gnavi-main">
				<div id="gnavi-main-child" class="clearfix">
					<ul class="clearfix js__base-h">
						<li><a href="about" class="clearfix"><span class="no">01.</span><span class="text">About Teckzite</span></a></li>
						<li><a href="events" class="clearfix"><span class="no">02.</span><span class="text">All Events</span></a></li>
						<li><a href="schedule" class="clearfix"><span class="no">03.</span><span class="text">Schedule</span></a></li>
												<li><a href="notices" class="clearfix"><span class="no">04.</span><span class="text">Notifications</span></a></li>
						
						<li><a href="team" class="clearfix"><span class="no">05.</span><span class="text">Team teckzite</span></a></li>
					</ul>
					<ul class="clearfix">
												<li><a href="login" class="clearfix"><span class="no">06.</span><span class="text">Login|Register</span></a></li>
												<li><a href="contact" class="clearfix"><span class="no">07.</span><span class="text">Contact Us</span></a></li>
						<li><a href="supportus" class="clearfix"><span class="no">08.</span><span class="text">Support Us</span></a></li>
						<li><a href="sponsors" class="clearfix"><span class="no">09.</span><span class="text">Sponsors</span></a></li>
						<li><a href="faq" class="clearfix"><span class="no">10.</span><span class="text">FAQ</span></a></li>
					</ul>
			...
			<div class="bg-container">
				...
				<div class="logo">
					<div class="logo-inner">
						...
						<h2><a href="index" style="color:white;text-decoration:none;">TECKZITE'18</a></h2>
...
<div class="row" style="width:100%;margin-top:5%;margin-left:15%;">
						<ul id="menu">
							...
							<li><a href="https://facebook.com/teckzite" target="_new"><img src="assets/img/social/youtube.png" class="socialimg"></a>/teckzite</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<li><a href="https://facebook.com/teckzite" target="_new"><img src="assets/img/social/twitter.png" class="socialimg"></a>/teckzite</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<li><img src="assets/img/social/gmail.png" class="socialimg">/support@teckzite.in</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<li><a href="https://facebook.com/teckzite" target="_new"><img src="assets/img/social/phone.png" class="socialimg"></a>/9989578198</li>
						</ul>
					</div>
							<!-- /#kv-hold-area -->
</div>
				...
				<div id="kv-contents">
					...
					<div id="kv-main-contents" class="js__posi-v-center">
						<div class="js__base-h">
							<h2 id="kv-copy" style="margin-top:4%;"><div class="js__shuffle">Teckzite'18</div></h2><p style="margin-top:-3%;font-size:20px;font-family:raleway;">--break the bleak</p>
						</div>
		...
		l14.797,19.958H177.13l14.797-19.958L177.13,0L177.13,0z"/>
					...
					<!--<p id="kv-bottom-text"><span class="js__flashing"><span id="kv-bottom-text-inner">
						THIS WEBGL EXPERIENCE IS USING HIGH-DEFINITION GRAPHICS. IF YOU EXPERIENCE ISSUES, USE
							GOOGLE CHROME OR FIREFOX, OR <a href="">BASIC TECHNOLOGY page-container</a>.
					</span></span></p>-->
...
<div id="page-body-bg">
    <div><canvas id="page-body-bg-canvas"></canvas></div>
</div>-->
