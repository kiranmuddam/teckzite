...
<div class="resume">
    ...
    <button type="button"  style="width:70%;" class="btn btn-success ribbon">Support</button>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="col-xs-12 col-sm-4">
              <figure>
                <img class="img-circle img-responsive" alt="" src="assets/img/support.jpg">
              </figure>
            ...
            <div class="col-xs-12 col-sm-8">
              <ul class="list-group">
               ...
               <li> <button class="list-group-item"><i class="fa fa-envelope-o"></i>&nbsp;&nbsp;support@teckzite.in</button></li>
                <li><button class="list-group-item"><i class="fa fa-envelope-o"></i>&nbsp;&nbsp;info@teckzite.in</button></li>
                <li><button class="list-group-item"><i class="fa fa-phone"></i>&nbsp;&nbsp;9090909090 </button></li>
